              ...
              <CardContent className="p-3 sm:p-4">
                ...
                <div className="flex items-center gap-2 mb-2">
                  <div className="flex gap-1">
                    <div className="w-6 h-9 sm:w-8 sm:h-12 bg-slate-800 rounded border border-slate-700 flex items-center justify-center text-xs text-slate-200">A♠</div>
                    <div className="w-6 h-9 sm:w-8 sm:h-12 bg-slate-800 rounded border border-slate-700 flex items-center justify-center text-xs text-slate-200">K♥</div>
                  </div>
              ...
              <CardContent className="p-3 sm:p-4">
                <div className="flex items-center gap-2 sm:gap-3">
                  ...
                  <div className="flex-1 min-w-0">
                    <div className="font-medium text-slate-200 text-sm sm:text-base truncate">User {i + 1}</div>
                    <div className="text-xs sm:text-sm text-slate-400 truncate">@user{i + 1}</div>
                  </div>
                  <Button size="sm" variant="outline" className="border-slate-700/30 text-xs sm:text-sm flex-shrink-0">
                    Following
                  </Button>
                </div>
              </CardContent>
  ...
  return (
    <div className="space-y-4 sm:space-y-6">
      <div className="text-center py-8 sm:py-12">
        ...
        <p className="text-slate-400 text-sm sm:text-base">Content for {activeTab} will be displayed here.</p>
      </div>
    </div>
  );
};