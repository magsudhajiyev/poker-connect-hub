      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex items-center justify-between h-16 sm:h-20">
          ...
          <div className="hidden md:flex items-center space-x-3 lg:space-x-4">
            ...
            <Link to="/auth">
              <Button className="px-4 lg:px-6 py-2 lg:py-3 bg-gradient-to-r from-emerald-500 to-violet-500 hover:from-emerald-600 hover:to-violet-600 text-slate-900 text-sm lg:text-[15px] font-medium flex items-center gap-2 transition-all duration-300">
