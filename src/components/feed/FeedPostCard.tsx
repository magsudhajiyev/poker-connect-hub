...
export const FeedPostCard = ({ hand, onHandClick, formatTimeAgo }: FeedPostCardProps) => {
  ...
  return (
    <Card className="bg-slate-800/40 border-slate-700/30 hover:bg-slate-800/60 transition-colors">
      <CardHeader className="flex flex-row items-center space-y-0 pb-3 cursor-pointer" onClick={handleCardClick}>
      ...
      <CardContent className="pt-0">
        ...
        <div className="flex items-center justify-between">
          <div className="flex items-center space-x-2 sm:space-x-4">
            ...
            >
              <Heart className={`w-3 h-3 sm:w-4 sm:h-4 mr-1 transition-all duration-200 ${
