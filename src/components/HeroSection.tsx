...
const HeroSection = () => {
  ...
  return (
    <div className="relative overflow-hidden">
      ...
      {isGateOpen && (
        <div className="fixed inset-0 bg-gradient-to-r from-emerald-500/20 via-transparent to-violet-500/20 z-20 pointer-events-none animate-pulse" />
      )}
    </div>
  );
};
