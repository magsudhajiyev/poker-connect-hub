...
import { ArrowLeft, Menu, Bell, Shield, User, Palette, HelpCircle } from 'lucide-react';
    ...
    <div className="min-h-screen bg-gradient-to-b from-slate-950 via-slate-900 to-slate-950 flex overflow-hidden">
      ...
      <div className={`flex-1 flex flex-col min-h-screen transition-all duration-300 ease-in-out overflow-hidden ${
        ...
        <div className="fixed top-0 right-0 z-50 bg-slate-950/80 backdrop-blur-xl border-b border-slate-800/50 transition-all duration-300 ease-in-out"
             style={{
               left: typeof window !== 'undefined' && window.innerWidth >= 1024 ? (isCollapsed ? '3rem' : '16rem') : '0',
             }}>
                    ...
                    <CardContent className="space-y-4 sm:space-y-6">
                      <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 sm:gap-6">
                        <div className="space-y-2">
                          ...
                          <Input
                            ...
                            className="bg-slate-900/50 border-slate-700/50 text-slate-200 h-9 sm:h-10"
                          />
                        </div>
                        <div className="space-y-2">
                      ...
                      <div className="space-y-2">
                        ...
                        <Textarea
                          ...
                          className="bg-slate-900/50 border-slate-700/50 text-slate-200 min-h-[80px] sm:min-h-[100px]"
                        />
                      </div>
                    ...
                    <CardContent className="space-y-4 sm:space-y-6">
                      <div className="flex items-center justify-between py-2 sm:py-3">
                        <div className="space-y-0.5">
                          ...
                          <p className="text-slate-400 text-xs sm:text-sm">Receive updates via email</p>
                        </div>
                        <Switch
                      ...
                      <div className="flex items-center justify-between py-2 sm:py-3">
                        <div className="space-y-0.5">
                          ...
                          <p className="text-slate-400 text-xs sm:text-sm">Receive browser notifications</p>
                        </div>
                        <Switch
                      ...
                      <div className="flex items-center justify-between py-2 sm:py-3">
                        <div className="space-y-0.5">
                          ...
                          <p className="text-slate-400 text-xs sm:text-sm">Get notified about comments on your hands</p>
                        </div>
                        <Switch
                    ...
                    <CardContent className="space-y-4 sm:space-y-6">
                      <div className="flex items-center justify-between py-2 sm:py-3">
                        <div className="space-y-0.5">
                          ...
                          <p className="text-slate-400 text-xs sm:text-sm">Add an extra layer of security</p>
                        </div>
                        <Switch
                      ...
                      <div className="flex items-center justify-between py-2 sm:py-3">
                        <div className="space-y-0.5">
                          ...
                          <p className="text-slate-400 text-xs sm:text-sm">Allow anonymous analytics</p>
                        </div>
                        <Switch
                          checked={dataSharing}
                      ...
                      <div className="flex items-center justify-between py-2 sm:py-3">
                        <div className="space-y-0.5">
                          ...
                          <p className="text-slate-400 text-xs sm:text-sm">Make your profile visible to others</p>
                        </div>
                        <Switch
