...
const Onboarding = () => {
  ...
  const experienceLevels = [
    ...
    { value: 'advanced', label: 'Advanced ♠️', description: 'Experienced player' },
        ...
        return (
          <div className="space-y-4 lg:space-y-6">
            <div className="text-center space-y-3 lg:space-y-4">
              <div className="text-4xl lg:text-6xl">{steps[currentStep].emoji}</div>
              ...
              <div>
                ...
                <Select value={formData.favoriteGame} onValueChange={(value) => setFormData(prev => ({ ...prev, favoriteGame: value }))}>
                  ...
                  <SelectContent className="bg-slate-800 border-slate-600">
                    {gameTypes.map((game) => (
                      <SelectItem key={game} value={game} className="text-slate-200 focus:bg-slate-700 text-sm lg:text-base">
                        {game}
                      </SelectItem>
                    ))}
                  </SelectContent>
              ...
              <div className="grid grid-cols-1 gap-2 lg:gap-3 mt-2 lg:mt-3">
                {goalOptions.map((goal) => (
                  <Badge
                    ...
                    className={`cursor-pointer p-2 lg:p-3 text-center justify-center text-xs lg:text-sm ${
